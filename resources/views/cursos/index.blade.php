    ...
    <div class="box sidebar-main" style="width: 150px;">
      <aside class="menu">
        <ul class="nav flex-column">
          ...
          <br>
          <li class="nav-item"><i class="fa-solid fa-chalkboard-user"></i><a class="is-size-5">Docentes</a></li>
          <br>
          ...
          <li class="nav-item"><i class="fa-solid fa-code"></i><a class="is-size-5">Aulas y laboratorios</a></li>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          ...
          <a class="btn btn-success"  href="{{url('/cursos/'.$curso->id.'/edit')}}" role="button" >Editar</a>    
              | 
          <form action="{{url('/cursos/'.$curso->id)}}" method="post">
            @csrf
            {{method_field('DELETE')}}
            <i class="fa-solid fa-trash"></i>
            <input class="btn btn-danger" type="submit" onclick="return confirm('¿Estás seguro de borrar el registro?')"
                  value="Borrar">
          </form>
        </td>
      </tr>
